...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Pelayanan Kesehatan Masyarakat</h1>
                </div>
            </div>
            ...
            <?php
                ...
                while($data = $show->fetch(PDO::FETCH_LAZY)){
                    ...
                    <tr>
                        ...
                        <td><a class='btn btn-info fa fa-pencil-square-o' href='edit-pelayanan-masyarakat.php?id_pelayanan=$data->id_pelayanan'> Edit </a> <p></p>
                        <a class='btn btn-danger fa fa-trash' href='data-pelayanan-hubungan.php?delete=$data->id_pelayanan'> Hapus</a></td>
                    </tr>";
                };
            ?>
