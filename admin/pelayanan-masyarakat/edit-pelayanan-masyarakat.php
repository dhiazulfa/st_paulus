...
$Lib = new Pelayanan();
$data = $Lib->editPelayanan($_GET['id_pelayanan']);
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Pelayanan Masyarakat</h1>
                </div>
            </div>

            <form class="row" action="edit-pelayanan-masyarakat" method="POST">
            <div class="form-group col-xs-4">
            <label>ID Pelayanan</label>
                <input type="text" name="id_pelayanan" class="form-control" value="'.$edit->id_pelayanan.'" readonly>
            </div>
            ...
            <form class="row" action="edit-pelayanan-masyarakat" method="POST">
                ...
                <div class="form-group col-xs-4">
                    ...
                    <select class="form-control" name="kategori_pelayanan"  value="'.$edit->kategori_pelayanan.'">
                    <option selected>Hubungan Masyarakat</option>
                ...
                <div class="form-group col-xs-12">
                    ...
                    <textarea type="text" name="berita_pelayanan" value="'.$edit->berita_pelayanan.'" class="form-control"  required></textarea>
                </div>

                <div class="form-group col-xs-2">
                    <label>Tanggal Pelayanan</label>
                    <div>
                        <input class="form-control" name="tgl_pelayanan"  value="'.$edit->tgl_pelayanan.'" type="date" required>
                    </div>
                </div>
                
                <div class="form-group col-xs-12">
                    <input type="submit" name="updatePelayanan" value="Update" class="btn btn-success">
                    <input type="reset" value="Reset" class="btn btn-danger">
                    <a class= "btn btn-info" href="data-pelayanan-masyarakat">Kembali</a>
                </div>
...
if(isset($_POST['updatePelayanan'])){
  ...
  $Lib = new Pelayanan();
  $upd = $Lib->updatePelayanan($id_pelayanan, $judul_berita, $kategori_pelayanan, $berita_pelayanan, $tgl_pelayanan);
