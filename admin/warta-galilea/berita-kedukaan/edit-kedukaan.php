...
if(isset($_GET['id_kedukaan'])){
$Lib = new Kedukaan();
$data = $Lib->editKedukaan($_GET['id_kedukaan']);
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form class="row" action="edit-kedukaan" method="POST">
                <div class="form-group col-xs-4">
                <label>ID Kedukaan</label>
                    <input type="text" name="id_kedukaan" value="'.$edit->id_kedukaan.'" class="form-control" readonly/>
                </div>
                
                <div class="form-group col-xs-4">
                    <label>Nama Duka</label>
                    <input type="text" name="nama_duka" class="form-control" value="'.$edit->nama_duka.'" required>
                </div>

                <div class="form-group col-xs-12">
                    <label>Berita Kedukaan</label>
                    <textarea class="form-control" name="berita_kedukaan" rows="5" value="'.$edit->berita_kedukaan.'" required></textarea>
                </div>

                <div class="form-group col-xs-2">
                    <label>Tanggal Kedukaan</label>
                    <div>
                        <input class="form-control" name="tgl_kedukaan" value="'.$edit->tgl_kedukaan.'" type="date" required>
                    </div>
                </div>
                ...
                <div class="form-group col-xs-2">
                    ...
                    <div>
                        <input class="form-control" name="tgl_pemakaman" value="'.$edit->tgl_pemakaman.'" type="date" required>
                    </div>
                </div>

                <div class="form-group col-xs-12">
                    <input type="submit" name="updateKedukaan" value="Update" class="btn btn-success">
...
if(isset($_POST['updateKedukaan'])){

    $id_kedukaan            = $_POST['id_kedukaan'];
    $nama_kedukaan          = $_POST['nama_kedukaan'];
    $berita_kedukaan        = $_POST['berita_kedukaan'];
    $tgl_kedukaan           = $_POST['tgl_kedukaan'];
    $tgl_pemakaman          = $_POST['tgl_pemakaman'];

  $Lib = new Kedukaan();
  $upd = $Lib->updateKedukaan($id_kedukaan, $nama_kedukaan, $berita_kedukaan, $tgl_kedukaan, $tgl_pemakaman);
