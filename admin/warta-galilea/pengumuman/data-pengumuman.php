...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <a type="button" class="btn btn-success fa fa-list" href="add-pengumuman"> Tambah</a>
          <br><br>
          ...
          <table class="table table-bordered">
            ...
            <?php
                ...
                while($data = $show->fetch(PDO::FETCH_LAZY)){
                    ...
                    <tr>
                        ...
                        <td><a class='btn btn-info fa fa-pencil-square-o' href='edit-pengumuman.php?id_pengumuman=$data->id_pengumuman'> Edit </a> <p></p>
                        <a class='btn btn-danger fa fa-trash' href='data-pengumuman.php?delete=$data->id_pengumuman'> Hapus</a></td>
                    </tr>";
                };
            ?>
            ...
            <?php
                if(isset($_GET['delete'])){
                   $del = $Lib->deleteAttention($_GET['delete']);
                    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=data-pengumuman" target="frmMain">';
                }
            ?>
