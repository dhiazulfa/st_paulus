...
$Lib = new Pengumuman();
$data = $Lib->editAttention($_GET['id_pengumuman']);
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form class="row" action="edit-pengumuman" method="POST">
                ...
                <div class="form-group col-xs-4">
                    ...
                    <input type="text" name="judul_pengumuman" class="form-control" value="'.$edit->judul_pengumuman.'" required>
                </div>

                <div class="form-group col-xs-12">
                    <label>Isi Pengumuman</label>
                    <textarea class="form-control" name="isi_pengumuman" rows="5" value="'.$edit->isi_pengumuman.'" required></textarea>
                </div>

                <div class="form-group col-xs-2">
                    <label>Date</label>
                    <div>
                        <input class="form-control" name="tgl_pengumuman" value="'.$edit->tgl_pengumuman.'" type="date" required>
                    </div>
                </div>

                <div class="form-group col-xs-12">
                    <input type="submit" name="updatePengumuman" value="Update" class="btn btn-success">
...
if(isset($_POST['updatePengumuman'])){
  ...
  $Lib = new Pengumuman();
  $upd = $Lib->updateAttention($id_pengumuman, $judul_pengumuman, $isi_pengumuman, $tgl_pengumuman);
