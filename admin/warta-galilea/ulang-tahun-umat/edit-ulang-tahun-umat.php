...
$Lib = new Ultah();
$data = $Lib->editUltah($_GET['id_ultah']);
...
<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="data-ulang-tahun-umat" class="fa fa-birthday-cake"> Ulang Tahun Umat</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../../liturgi/jadwal-ekaristi/data-jadwal-ekaristi"class="fa fa-bookmark-o">Jadwal Ekaristi</a>
                            </li>
                            <li>
                    ...
                    <ul class="nav nav-second-level">
                    <li>
                    <a href="../../persekutuan/data-legio-maria" class="fa fa-balance-scale"> Legio Maria</a>
                    </li>
                    <li>
                    <a href="../../persekutuan/data-pemberdayaan-wanita" class="fa fa-female"> Pemberdayaan Wanita</a>
                    </li>
                    <li>
                    <a href="../../persekutuan/data-ssv" class="fa fa-snapchat-ghost"> SSV</a>
                    </li>
                    </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                            <a href="../../pewartaan/data-pewartaan-piud" class="fa fa-star">PIUD</a>
                            </li>
                            <li>
                                <a href="../../pewartaan/data-pewartaan-omk"class="fa fa-anchor"> OMK</a>
                            </li>
                            <li>
                                <a href="../../pewartaan/data-pewartaan-lansia" class="fa fa-heart"> Lansia</a>
                            </li>
                            <li>
                                <a href="../../pewartaan/data-pewartaan-katekis" class="fa fa-gavel"> Katekis</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Ulang Tahun Umat</h1>
                </div>
            </div>
            
            <form class="row" action="edit-ulang-tahun-umat" method="POST">
                <div class="form-group col-xs-4">
                <label>ID Ultah</label>
                    <input type="text" name="id_ultah" value="'.$edit->id_ultah.'" class="form-control" readonly/>
                </div>
                
                <div class="form-group col-xs-4">
                    <label>Nama Umat</label>
                    <input type="text" name="nama_umat" class="form-control" value="'.$edit->nama_umat.'" required>
                </div>

                <div class="form-group col-xs-2">
                    <label>Tanggal Lahir</label>
                    <div>
                        <input class="form-control" name="tgl_lahir" value="'.$edit->tgl_lahir.'" type="date" required>
                    </div>
                </div>

                <div class="form-group col-xs-12">
                    <input type="submit" name="updateUltah" value="Update" class="btn btn-success">
                    <input type="reset" value="Reset" class="btn btn-danger">
                    <a class= "btn btn-info" href="data-ulang-tahun-umat">Kembali</a>
                </div>
...
if(isset($_POST['updateUltah'])){

    $id_ultah            = $_POST['id_ultah'];
    $nama_umat          = $_POST['nama_umat'];
    $tgl_lahir          = $_POST['tgl_lahir'];

  $Lib = new Ultah();
  $upd = $Lib->updateUltah($id_ultah, $nama_umat, $tgl_lahir);
