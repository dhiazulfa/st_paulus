...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <a type="button" class="btn btn-success fa fa-list" href="add-ulang-tahun-umat"> Tambah</a>
          <br><br>
          ...
          <table class="table table-bordered">
            ...
            <?php
                ...
                while($data = $show->fetch(PDO::FETCH_LAZY)){
                    ...
                    <tr>
                        ...
                        <td><a class='btn btn-info fa fa-pencil-square-o' href='edit-ulang-tahun-umat.php?id_ultah=$data->id_ultah'> Edit </a> <p></p>
                        <a class='btn btn-danger fa fa-trash' href='data-ulang-tahun-umat.php?delete=$data->id_ultah'> Hapus</a></td>
                    </tr>";
                };
            ?>
            ...
            <?php
                if(isset($_GET['delete'])){
                   $del = $Lib->deleteUltah($_GET['delete']);
                    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=data-ulang-tahun-umat">';
                }
            ?>
