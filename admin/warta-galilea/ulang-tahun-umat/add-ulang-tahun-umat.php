...
<div id="wrapper">
            ...
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../../persekutuan/legio-maria/data-legio-maria" class="fa fa-balance-scale"> Legio Maria</a>
                            </li>
                            <li>
                                <a href="../../persekutuan/pemberdayaan-wanita/data-pemberdayaan-wanita" class="fa fa-female"> Pemberdayaan Wanita</a>
                            </li>
                            <li>
                                <a href="../../persekutuan/SSV/data-ssv" class="fa fa-snapchat-ghost"> SSV</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="../../data-pewartaan-omk"class="fa fa-anchor">OMK</a>
                            </li>

                            <li>
                                <a href="../../data-pewartaan-lansia" class="fa fa-heart"> Lansia</a>
                             </li>

                             <li>   
                                <a href="../../data-pewartaan-katekis" class="fa fa-gavel"> Katekis</a>
                            </li>
                        </ul>
                    </li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form class="row" action="add-ulang-tahun-umat" method="POST">
                <div class="form-group col-xs-4">
                    <label>Nama Umat</label>
                    <input type="text" name="nama_umat" class="form-control" required>
                </div>

                <div class="form-group col-xs-2">
                    <label>Tanggal Lahir</label>
                    <input class="form-control" name="tgl_lahir" type="date" required></input>
                </div>
                    </div>

                <div class="form-group col-xs-12">
                    <input type="submit" name="addUltah" value="Tambah" class="btn btn-success">
                ...
                <?php
                    ...
                    if(isset($_POST['addUltah'])) {
                        $nama_umat          =   $_POST['nama_umat'];
                        $tgl_lahir      =   $_POST['tgl_lahir'];

                        $Lib    = new Ultah();
                        $add    = $Lib->addUltah($nama_umat, $tgl_lahir);
                        if($add == 'Success') {
                            echo '<script language="javascript"> alert("Data ditambah!"); 
                            document.location="data-ulang-tahun-umat"; </script>';
                        }
                    }
