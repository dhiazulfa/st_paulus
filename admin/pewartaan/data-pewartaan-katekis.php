...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Pewartaan Katekis</h1>
                </div>
            </div>

            <a type="button" class="btn btn-success fa fa-list" href="add-pewartaan"> Tambah</a>
          <br><br>
          ...
          <table class="table table-bordered">
            <thead class="thead-dark">
                ...
                <th scope="col">Kategori Pewartaan</th>
                <th scope="col">Berita Pewartaan</th>
                <th scope="col">Tanggal Pewartaan</th>
            ...
            <?php
                ...
                while($data = $show->fetch(PDO::FETCH_LAZY)){
                    ...
                    <tr>
                        ...
                        <td>$data->kategori_pewartaan</td>
                        <td>$data->berita_pewartaan</td>
                        <td>$data->tgl_pewartaan</td>
                        <td><a class='btn btn-info fa fa-pencil-square-o' href='edit-pewartaan.php?id_pewartaan=$data->id_pewartaan'> Edit </a> <p></p>
                        <a class='btn btn-danger fa fa-trash' href='data-pewartaan-katekis.php?delete=$data->id_pewartaan'> Hapus</a></td>
                    </tr>";
                };
            ?>
            ...
            <?php
                if(isset($_GET['delete'])){
                   $del = $Lib->deletePewartaan($_GET['delete']);
                    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=data-pewartaan">';
                }
            ?>
