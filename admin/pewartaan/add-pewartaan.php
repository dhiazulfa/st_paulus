...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form class="row" action="add-pewartaan" method="POST">
                ...
                <div class="form-group col-xs-4">
                    ...
                    <select class="form-control" name="kategori_pewartaan">
                ...
                <div class="form-group col-xs-12">
                    ...
                    <textarea type="text" name="berita_pewartaan" class="form-control"  required></textarea>
                </div>

                <div class="form-group col-xs-2">
                    <label>Tanggal Pewartaan</label>
                    <div>
                        <input class="form-control" name="tgl_pewartaan" type="date" required>
                    </div>
                </div>


                <div class="form-group col-xs-12">
                    <input type="submit" name="addPewartaan" value="Tambah" class="btn btn-success">
                    <input type="reset" value="Reset" class="btn btn-danger">
                    <a class= "btn btn-info" href="data-pewartaan-piud">Kembali</a>
                </div>

                <?php
                    require("../lib/library.php");
                    
                    if(isset($_POST['addPewartaan'])) {
                        ...
                        $Lib    = new Pewartaan();
                        $add    = $Lib->addPewartaan($judul_berita, $kategori_pewartaan, $berita_pewartaan, $tgl_pewartaan);
                        if($add == 'Success') {
                            echo '<script language="javascript"> alert("Data ditambah!"); 
                            document.location="data-pewartaan"; </script>';
                        }
                    }
