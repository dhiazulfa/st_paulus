...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form class="row" action="add-petugas-liturgi" method="POST">
                ...
                <div class="form-group col-xs-2">
                    ...
                    <input class="form-control" name="no_telefon" type="text" required></input>
                </div>

                <div class="form-group col-xs-12">
                    <label>Alamat</label>
                    <div>
                        <textarea class="form-control" type="text" name="alamat" rows="5" required></textarea>
                    </div>
                </div>

                <div class="form-group col-xs-12">
                    <input type="submit" name="addPetugas" value="Tambah" class="btn btn-success">
                ...
                <?php
                    ...
                    if(isset($_POST['addPetugas'])) {
                        ...
                        $add    = $Lib->addPetugas($nama_petugas, $no_telefon, $alamat);
                        if($add == 'Success') {
                            echo '<script language="javascript"> alert("Pengumuman Dibuat!"); 
                            document.location="data-petugas-liturgi"; </script>';
                        }
                    }
