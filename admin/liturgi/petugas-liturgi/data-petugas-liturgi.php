...
<div id="wrapper">
            ...
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../jadwal-ekaristi/data-jadwal-ekaristi.php"class="fa fa-bookmark-o"> Jadwal Ekaristi</a>
                            </li>
                            <li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <a type="button" class="btn btn-success fa fa-list" href="add-petugas-liturgi"> Tambah</a>
          <br><br>
          ...
          <table class="table table-bordered">
            ...
            <?php
                ...
                while($data = $show->fetch(PDO::FETCH_LAZY)){
                    ...
                    <tr>
                        ...
                        <td>$data->alamat</td>
                        <td><a class='btn btn-info fa fa-pencil-square-o' href='edit-petugas-liturgi.php?id_petugas=$data->id_petugas'> Edit </a> <p></p>
                        <a class='btn btn-danger fa fa-trash' href='data-petugas-liturgi.php?delete=$data->id_petugas'> Hapus</a></td>
                    </tr>";
                };
            ?>
            ...
            <?php
                if(isset($_GET['delete'])){
                   $del = $Lib->deletePetugas($_GET['delete']);
                    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=data-petugas-liturgi">';
                }
            ?>
