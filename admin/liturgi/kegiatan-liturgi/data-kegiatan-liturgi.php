...
<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="data-kegiatan-liturgi.php"class="fa fa-database"> Kegiatan Bidang Liturgi</a>
                            </li>
                        </ul>
                    </li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <a type="button" class="btn btn-success fa fa-list" href="add-kegiatan-liturgi"> Tambah</a>
          <br><br>
          ...
          <table class="table table-bordered">
            <thead class="thead-dark">
                ...
                <th scope="col">Lihat Selengkapnya</th>
            ...
            <?php
                ...
                while($data = $show->fetch(PDO::FETCH_LAZY)){
                    ...
                    <tr>
                        ...
                        <td><a href='data-kegiatan-satuan.php?id_kegiatan=$data->id_kegiatan'>Selengkapnya</a></td>
 
                        <td><a class='btn btn-info fa fa-pencil-square-o' href='edit-kegiatan-liturgi.php?id_kegiatan=$data->id_kegiatan'> Edit </a> <p></p>
                        <a class='btn btn-danger fa fa-trash' href='data-kegiatan-liturgi.php?delete=$data->id_kegiatan'> Hapus</a></td>
                    </tr>";
                };
            ?>
            ...
            <?php
                if(isset($_GET['delete'])){
                   $del = $Lib->deleteKegiatan($_GET['delete']);
                    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=data-kegiatan-liturgi">';
                }
            ?>
