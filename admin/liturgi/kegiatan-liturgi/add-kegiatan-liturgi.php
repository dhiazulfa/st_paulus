...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form class="row" action="add-kegiatan-proses.php" method="POST" enctype="multipart/form-data">
                <div class="form-group col-xs-12">
                    <label>Nama Kegiatan</label>
                    <input class="form-control" name="nama_kegiatan" required></input>
                </div>

                <div class="form-group col-xs-2">
                    <label>Tanggal Kegiatan</label>
                    <input type="date" class="form-control" name="tgl_kegiatan" required></input>
                </div>
                ...
                <div class="form-group col-xs-12">
                    <input type="submit" name="addKegiatan" value="Tambah" class="btn btn-success">
                    <input type="reset" value="Reset" class="btn btn-danger">
                    <a class= "btn btn-info" href="data-kegiatan-liturgi">Kembali</a>
                </div>
