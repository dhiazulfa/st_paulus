...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form class="row" action="add-jadwal-ekaristi" method="POST">
                <div class="form-group col-xs-4">
                    <label>Jadwal Ekaristi</label>
                    <input type="text" name="tempat_ibadah" class="form-control" required>
                </div>

                <div class="form-group col-xs-2">
                    <label>Tgl Ibadah</label>
                    <input class="form-control" name="tgl_ibadah" type="date" required></input>
                </div>
                ...
                <div class="form-group col-xs-12">
                    <input type="submit" name="addJadwal" value="Tambah" class="btn btn-success">
                ...
                <?php
                    ...
                    if(isset($_POST['addJadwal'])) {
                        ...
                        $add    = $Lib->addJadwal($tempat_ibadah, $tgl_ibadah, $keterangan);
                        if($add == 'Success') {
                            echo '<script language="javascript"> alert("Pengumuman Dibuat!"); 
                            document.location="data-jadwal-ekaristi"; </script>';
                        }
                    }
