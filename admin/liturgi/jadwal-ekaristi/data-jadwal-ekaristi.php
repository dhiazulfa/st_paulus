...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <a type="button" class="btn btn-success fa fa-list" href="add-jadwal-ekaristi"> Tambah</a>
          <br><br>
          ...
          <table id="data" class="table table-bordered">
            ...
            <?php
                ...
                while($data = $show->fetch(PDO::FETCH_LAZY)){
                    ...
                    <tr>
                        ...
                        <td><a class='btn btn-info fa fa-pencil-square-o' href='edit-jadwal-ekaristi.php?id_jadwal=$data->id_jadwal'> Edit </a> <p></p>
                        <a class='btn btn-danger fa fa-trash' href='data-jadwal-ekaristi.php?delete=$data->id_jadwal'> Hapus</a></td>
                    </tr>";
                };
            ?>
            ...
            <?php
                if(isset($_GET['delete'])){
                   $del = $Lib->deleteJadwal($_GET['delete']);
                    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=data-jadwal-ekaristi">';
                }
            ?>
